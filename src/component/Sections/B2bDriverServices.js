...
// import SimpleSlider from "../Sliders/Slider_B2b";
import SimpleSlider from "../Sections/Sliders/Slider_B2b";

import {B2bDriverServices_main_heading_styles,B2bDriverServices_main_description_styles,B2bDriverServices_heading_styles,B2bDriverServices_description_styles} from "../../utils/Contants"
...
const B2bDriverServices = () => {
  ...
  const renderSlide = (image, backgroundStyle) => (
    <Grid item md={12} sx={{ display: "flex", flexDirection: "row" }}>
      ...
      <Grid item sx={{ display: 'flex', flexDirection: "column", alignItems: 'start', gap: "20px", padding: "10px 30px 20px 15px", ...backgroundStyle }}>
        <Typography sx={B2bDriverServices_heading_styles}>Pickup & Drop Service</Typography>
        <Typography sx={B2bDriverServices_description_styles}>
  ...
  return (
    <>
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "30px 50px" }}>
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: '31px' }}>
          <Typography sx={B2bDriverServices_main_heading_styles}> B2b driver services</Typography>
          <Typography sx={B2bDriverServices_main_description_styles}>
